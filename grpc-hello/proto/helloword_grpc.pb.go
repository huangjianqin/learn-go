...
type GreeterClient interface {
	...
	KeepSayHello(ctx context.Context, opts ...grpc.CallOption) (Greeter_KeepSayHelloClient, error)
}
...
func (c *greeterClient) KeepSayHello(ctx context.Context, opts ...grpc.CallOption) (Greeter_KeepSayHelloClient, error) {
...
func (x *greeterKeepSayHelloClient) Send(m *HelloRequest) error {
...
type GreeterServer interface {
	...
	KeepSayHello(Greeter_KeepSayHelloServer) error
...
func (UnimplementedGreeterServer) KeepSayHello(Greeter_KeepSayHelloServer) error {
...
func _Greeter_KeepSayHello_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).KeepSayHello(&greeterKeepSayHelloServer{stream})
}
...
func (x *greeterKeepSayHelloServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
